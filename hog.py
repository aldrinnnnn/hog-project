...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while (max(score0,score1) < goal):
        ...
        # BEGIN PROBLEM 6
        f = say(score0,score1) if first_turn else f(score0,score1)
        first_turn = False
        # END PROBLEM 6
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    max_sofar = make_averaged(roll_dice)(1,dice)
    max_dice = 1
    for i in range(10,1,-1):
        current = make_averaged(roll_dice)(i,dice)
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if picky_piggy(opponent_score) + score == opponent_score or picky_piggy(opponent_score) >= cutoff:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
